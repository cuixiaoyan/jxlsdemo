...
public class ObjectCollectionDemo {
    ...
    public static void main(String[] args) throws ParseException, IOException {
        ...
        OutputStream os = new FileOutputStream("/Users/cuixiaoyan/Downloads/aaa.xls");
        Map<String , Object> model=new HashMap<String , Object>();
        model.put("employees", employees);
        model.put("nowdate", new Date());

        InputStream inputStream = new FileInputStream("/Users/cuixiaoyan/Downloads/object_collection_template.xls");
